...
if __name__ == "__main__":
    save_distances_to_csv(
        log_path=r"C:\Users\24847\Downloads\uwb_aoa_algorithm-main\uwb_aoa_algorithm-main\data\0902\dis_0902_150.log",  # 替换为您的日志文件路径
        output_csv="0902_150_distance_data.csv"
    )